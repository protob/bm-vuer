    ...
    <SchemaFormWithValidation :schema="schema" @submit="formSubmit">
      <template #afterForm>
        <div class="flex justify-between pt-8">
          <PrtButton :native-type="'submit'"> Login </PrtButton>
          <PrtButton :native-type="'button'" @click="cancel"> Cancel </PrtButton>
        </div>
      </template>
...
const factory = SchemaFormFactory([VeeValidatePlugin({})], { formField });
